...
class gsUser extends gsAPI{
    ...
    /*
    Gets a stream key if you have a premium account
    */
    public function getSubscriberStreamKey($songID, $lowBitrate=false) {
        ...
        $return = parent::apiCall('getSubscriberStreamKey',array('songID'=>$songID, 'country'=>$this->parent->country, 'sessionID'=>$this->parent->session, 'lowBitrate'=>$lowBitrate));
